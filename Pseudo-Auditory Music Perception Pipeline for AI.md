Project Title: Pseudo-Auditory Music Perception Pipeline for AI
Author: Janne Honkonen, Bs.e. 
Location: Saarijärvi
...
3. Lyrics Mapping (Time-Aligned Subtitles):
...
4. Contextual Modeling & Narrative Mapping:
...
Status: Conceptual. Not yet implemented. Contributions welcome.

License: Open for public domain experimentation, research, and adaptation. Attribution expected.